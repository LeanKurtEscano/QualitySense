    ...
    <section className='flex  bg-darkbg min-h-screen items-center justify-center flex-wrap'>
      <div className=' flex flex-col'>
        <div className='flex items-center justify-center mb-4'>
          <h1 className='md:text-6xl text-4xl font-bold text-white'>Main <span className='bg-gradient-to-br md:text-6xl text-4xl from-cyan-500 to-blue-700 bg-clip-text text-transparent font-bold'>Features</span></h1>
        </div>
      ...
      <div className='w-max flex flex-wrap items-center justify-center'>
        {features.map((item, index) => (
          ...
          >
            ...
            <div className='flex-grow flex p-3 md:w-[400px] h-[180px] flex-col border-2 border-cyan-800 rounded-lg'>
              <h1 className='text-lg text-slate-300 mb-2 font-semibold'>{item.title}</h1>
              <div className='flex md:w-[300px] w-[280px] mb-3'>
