...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className={`h-full ${toggle ? 'w-16' : 'w-64'} transition-all duration-700`}>
      ...
      <nav className='h-full flex flex-col justify-self-center p-4 items-center pt-20 bg-white border-r shadow-sm'>
